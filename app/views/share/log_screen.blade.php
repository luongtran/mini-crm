...
<head>
    ...
    body {
     ...
     <script type="text/javascript" src="{{asset('asset/backend/assets/js/jquery.min.js')}}"></script>
    ...
    <link rel="stylesheet" href="{{asset('asset/backend/assets/css/extra-pages.css')}}">

...
<div class="col-sm-12">                                                                 
			            ...
			            <div class="row">                   
			                    ...
			                    {{Form::open(array('method'=>'PUT','url'=>'manager/news/'.$view->id,'enctype'=>'multipart/form-data'))}}
			                    <div class="body-nest" id="basic">				                  
				                    ...
				                    <div class="form-group">
				                        {{Form::label('Category')}} 				                 
				                        {{Form::select('category_id',$category,$view->category_id,array('class'=>'form-control'))}}       

            ...
            <div class="content-page">
                  ...
                  <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                      <div class="item active">
                        <img src="{{asset('')}}asset/frontend/pages/img/pics/img2-medium.jpg" alt="">
                        <div class="carousel-caption">
                          <p>Excepturi sint occaecati cupiditate non provident</p>
                        </div>
                      </div>
                      <div class="item">
                        <img src="{{asset('')}}asset/frontend/pages/img/pics/img1-medium.jpg" alt="">
                        <div class="carousel-caption">
              ...
              <div class="row front-team">
                <ul class="list-unstyled">
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="{{asset('')}}asset/frontend/pages/img/people/img1-large.jpg">
                      <h3>
                  ...
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="{{asset('')}}asset/frontend/pages/img/people/img4-large.jpg">
                      <h3>
                  ...
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="{{asset('')}}asset/frontend/pages/img/people/img2-large.jpg">
                      <h3>
                  ...
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="{{asset('')}}asset/frontend/pages/img/people/img5-large.jpg">
                      <h3>

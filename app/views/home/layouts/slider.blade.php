        ...
        <div class="fullwidthabnner">
          <ul id="revolutionul">
            ...
            <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="{{asset('')}}asset/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
              ...
              <a class="caption lft btn dark slide_btn slide_item_left"  href="{{url('#')}}"
                data-x="187"
                data-y="315"
                data-speed="400"
                data-start="3000"
            ...
            <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="{{asset('')}}asset/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
              ...
              <a class="caption lft btn green slide_btn slide_item_left"  href="{{url('#')}}"
                data-x="30"
                data-y="290"
                data-speed="400"
                data-start="3000"
              ...
              <a class="caption lfr btn yellow slide_btn" href=""
                ...
                data-y="280"
                        ...
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="{{asset('')}}asset/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
                            ...
                            <a class="caption lft slide_btn btn red slide_item_left" href="{{url('#')}}" target="_blank" 
                                 data-x="30"
                                 data-y="300"
                                 data-speed="400"
                                 data-start="3000"

...
head.js(spBaseUrl+"/asset/backend/assets/js/custom/scriptbreaker-multiple-accordion-1.js", function() {

    $(".topnav").accordionze({
        accordionze: true,
        speed: 500,
        closedSign: '<img src="'+spBaseUrl+'/asset/backend/assets/img/plus.png">',
        openedSign: '<img src="'+spBaseUrl+'/asset/backend/assets/img/minus.png">'
    });
